      ...
      <div className="page-container__content">
        <div className="profile__wallet-container">
          <div className="profile__wallet-container__battleblocks">
            battleblocks-wallet: <span className="wallet-container__address">{user.custodialWalletAddress}</span>
          </div>
          {user.selfCustodyWalletAddress ? (
            <div className="profile__wallet-container__connected">
              personal-wallet:{' '}
              <span className="wallet-container__address">{user.selfCustodyWalletAddress || bloctoUser?.addr}</span>
            </div>
          ) : (
            <div className="profile__wallet-container__connect" onClick={() => cosign(user.custodialWalletAddress)}>
